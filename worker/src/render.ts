...
<div id="about-overlay">
  <div id="about-modal">
    ...
    <ol>
      ...
      <li>Run <code>/game-builder</code> in a Claude Code session</li>
      <li>Drop the generated <code>.html</code> into <code>worker/public/games/</code> and add an entry to <code>worker/games.json</code></li>
